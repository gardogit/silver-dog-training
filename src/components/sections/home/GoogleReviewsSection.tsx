...
const reviewsData: ReviewData[] = [
  {
    ...
    reviewText:
      "El entrenamiento personalizado ha sido un antes y un después para mi perro. El equipo es increíblemente profesional y paciente. ¡Lo recomiendo totalmente!",
    rating: 5,
  ...
  },
  {
    ...
    reviewText:
      "Apunté a mi cachorro a las clases grupales y ha mejorado muchísimo en su socialización. El ambiente es controlado y muy positivo. Gran trabajo.",
    rating: 5,
  ...
  },
  {
    ...
    reviewText:
      "El entrenamiento K9 es de otro nivel. La atención al detalle y la profesionalidad son impresionantes. Mi perro ha desarrollado unas habilidades increíbles.",
    rating: 5,
  ...
  },
  {
    ...
    reviewText:
      "Servicio excepcional y resultados visibles en poco tiempo. El método que utilizan funciona de maravilla y el trato es inmejorable.",
    rating: 5,
  ...
  },
  {
    ...
    reviewText:
      "Estamos encantados con el progreso de nuestro perro. Las sesiones son dinámicas y muy bien estructuradas. ¡100% recomendable!",
    rating: 5,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-neutral-600 max-w-3xl mx-auto leading-relaxed">
            Nos enorgullece el impacto positivo que tenemos en perros y sus
            familias. Aquí tienes algunas de las opiniones que nos han dejado en
            Google.
          </p>
        </div>
